...
<html>
    <head>
        ...
        <title>Kata - Karate Al Doble</title>
        ...
        <div class="main-container">
            <aside class="sidebar">
                ...
                <nav class="main-nav">
                    <ul>
                        ...
                        <li><a href="KataPage_Servlet" class="nav-link active">Kata</a></li>
            ...
            <main class="content-area">
                <header class="content-header" data-aos="fade-down">
                    <h1>Sección de Kata</h1>
                    <p>Explora la forma del Karate a través de nuestros videos explicativos y descripciones detalladas.</p>
                </header>
                    ...
                    <c:forEach var="video" items="${videos}">
                        <div class="video-item" data-aos="fade-up">
                            <div class="video-player">
                                <c:choose>
                                    <c:when test="${video.urlVideo.length() > 15}">
                                        <iframe src="https://drive.google.com/file/d/${video.urlVideo}/preview" frameborder="0" allowfullscreen></iframe>
                                    </c:when>
                                    <c:otherwise>
